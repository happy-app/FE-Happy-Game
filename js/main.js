...
$(document).ready(function(){
  $(".ppiece1").on("dragstart", floatingWindow.dragstart_handler);
  $(".ppiece2").on("dragstart", floatingWindow.dragstart_handler);
  $(".ppiece3").on("dragstart", floatingWindow.dragstart_handler);
  $(".ppiece4").on("dragstart", floatingWindow.dragstart_handler);
